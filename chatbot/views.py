...
def questionnaire_view(request):
    ...
    {'question': '1. From 1 to 7 (where 1 is the least and 7 is the most), the chatbot is natural.', choices: ['1', '2', '3', '4', '5', '6', '7']},
    {'question': '2. From 1 to 7 (where 1 is the least and 7 is the most), the chatbot is humanlike.', choices: ['1', '2', '3', '4', '5', '6', '7']},
    {'question': '3. From 1 to 7 (where 1 is the least and 7 is the most), the chatbot is realistic.', choices: ['1', '2', '3', '4', '5', '6', '7']},
    {'question': '4. From 1 to 7 (where 1 is the least and 7 is the most), the chatbot is present.', choices: ['1', '2', '3', '4', '5', '6', '7']},
    {'question': '5. From 1 to 7 (where 1 is the least and 7 is the most), the chatbot is authentic.', choices: ['1', '2', '3', '4', '5', '6', '7']},
    {'question': '1. From 1 to 5 (where 1 is the least and 5 is the most), my friends would say I\\’m a very patient friend.', choices: ['1', '2', '3', '4', '5']},
    {'question': '2. From 1 to 5 (where 1 is the least and 5 is the most), I am able to wait-out tough times.', choices: ['1', '2', '3', '4', '5']},
    {'question': '3. From 1 to 5 (where 1 is the least and 5 is the most), although they\\’re annoying, I don\\’t get too upset when stuck in traffic jams.', choices: ['1', '2', '3', '4', '5']},
    {'question': '4. From 1 to 5 (where 1 is the least and 5 is the most), I am patient with other people.', choices: ['1', '2', '3', '4', '5']},
    {'question': '5. From 1 to 5 (where 1 is the least and 5 is the most), I find it pretty easy to be patient with a difficult life problem or illness.', choices: ['1', '2', '3', '4', '5']},
    {'question': '6. From 1 to 5 (where 1 is the least and 5 is the most), in general waiting in lines does not bother me.', choices: ['1', '2', '3', '4', '5']},
    {'question': '7. From 1 to 5 (where 1 is the least and 5 is the most), I have trouble being patient with my close friends and family.', choices: ['1', '2', '3', '4', '5']},
    {'question': '8. From 1 to 5 (where 1 is the least and 5 is the most), I am patient during life hardships.', choices: ['1', '2', '3', '4', '5']},
    {'question': '9. From 1 to 5 (where 1 is the least and 5 is the most), when someone is having difficulty learning something new, I will be able to help them without getting frustrated or annoyed.', choices: ['1', '2', '3', '4', '5']},
    {'question': '10. From 1 to 5 (where 1 is the least and 5 is the most), I get very annoyed at red lights.', choices: ['1', '2', '3', '4', '5']},
    {'question': '11. From 1 to 5 (where 1 is the least and 5 is the most), I find it easy to be patient with people.', choices: ['1', '2', '3', '4', '5']},
